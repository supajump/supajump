...
-- triggers
create trigger set_timestamps_usage_meters before insert
or
update on public.usage_meters for each row
...
-- triggers
create trigger set_timestamps_usage_events before insert
or
update on public.usage_events for each row
execute function supajump.trigger_set_timestamps ();
...
-- triggers
create trigger set_timestamps_meter_credits before insert
or
update on public.meter_credits for each row
execute function supajump.trigger_set_timestamps ();
